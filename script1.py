...
import pyautogui
import imutils
# here we define function press
def Press(key):
    pyautogui.press(key)
# cap capture the webcam frame
...
while True:
    ...
    cv2.putText(frame, 'RIDE', (70, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3, cv2.LINE_AA)
    ...
    cv2.putText(frame, 'HITHAT close', (445, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 3, cv2.LINE_AA)
    cv2.rectangle(frame, (660, 0), (900, 150), (0, 0, 255), 1)
    cv2.putText(frame, 'CRASH', (730, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 3, cv2.LINE_AA)
    ...
    cv2.putText(frame, 'HIT HAT', (770, 290), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3, cv2.LINE_AA)
